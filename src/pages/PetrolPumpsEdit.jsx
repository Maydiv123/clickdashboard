              ...
              <Grid item xs={12}>
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
                  ...
                  <Button
                    ...
                    onClick={() => {
                      const url = `https://www.google.com/maps?q=${editFormData.latitude},${editFormData.longitude}`;
                ...
                >
                  <iframe
                    ...
                    frameBorder="0"
                    style={{ border: 0 }}
                    src={`https://www.google.com/maps/embed/v1/place?key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8&q=${editFormData.latitude},${editFormData.longitude}`}
                    allowFullScreen
                    loading="lazy"
